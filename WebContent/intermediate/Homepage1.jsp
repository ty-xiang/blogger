...
<body>
	...
	<div class="container-fluid">
		...
		<div class="col-sm-3">
			...
			<!-- <input type="text" name="search" id="search" class="form-control" style="margin-top: 9px;"> --> 	
		</div>
		...
		<div class="row content">
			...
			<div class="col-sm-8">
				...
				<div class="col-sm-8">   <!-- articles -->
						<div class="row">
							<div class="col-sm-2"><h2 style="display:inline">Articles</h2> 
							</div>
							<div class="col-sm-4">
					...
					<div class="panel panel-default">
					  <div class="panel-heading">
					  	  <span class="glyphicon glyphicon-heart" name="${article.article_id}" aria-hidden="true"></span><span>  ${article.likes}</span>
					  ...
					  <div class="panel-body" >
					  		<h5><span class="glyphicon glyphicon-time"></span> Post by ${article.author}, ${article.postDate}.</h5>
